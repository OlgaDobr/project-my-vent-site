...
import Поставкаоборудования from '../assets/img service/Поставка оборудования.jpeg';
	...
	function ServicesPage() {
	  const services = [
		...
		{ id: 5, title: 'Выезд на объект, рсчеты и замеры', description: 'Широкий ассортимент вентиляционного оборудования от ведущих производителей.', imageUrl: '/images/service-supply.jpg' },
		{ id: 6, title: 'Выполнение сантехнических работ под ключ', description: 'Широкий ассортимент вентиляционного оборудования от ведущих производителей.', imageUrl: '/images/service-supply.jpg' },
	  ];
