...
import Безназвания2 from '../assets/img/Без названия 2.jpeg';
	
	function ServicesPage() {
	  const services = [
	    { id: 1, title: 'Проектирование систем вентиляции', description: 'Разработка индивидуальных проектов с учетом всех требований и особенностей объекта.', imageUrl: 'Без названия 2.jpeg' },
